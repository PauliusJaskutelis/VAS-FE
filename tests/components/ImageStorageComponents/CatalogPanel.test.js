...
jest.mock('@mui/material/Collapse', () => (props) => (props.in ? _jsx("div", { children: props.children }) : null));
const mockTree = [
    {
        id: '1',
        name: 'Root',
...
describe('CatalogPanel', () => {
    it('renders root and subfolder', () => {
        render(_jsx(CatalogPanel, { tree: mockTree, selectedPath: ['Root', 'Subfolder'], onSelect: () => { } }));
        expect(screen.getByText('Root')).toBeInTheDocument();
        expect(screen.getByText('Subfolder')).toBeInTheDocument();
    });
    it('calls onSelect with correct path', () => {
        const handleSelect = jest.fn();
        render(_jsx(CatalogPanel, { tree: mockTree, selectedPath: ['Root', 'Subfolder'], onSelect: handleSelect }));
    ...
    it('calls onDelete with correct path', () => {
        ...
        render(_jsx(CatalogPanel, { tree: mockTree, selectedPath: ['Root', 'Subfolder'], onSelect: () => { }, onDelete: handleDelete }));
    ...
    it('calls onAdd with correct path and folder name', () => {
        ...
        render(_jsx(CatalogPanel, { tree: mockTree, selectedPath: ['Root', 'Subfolder'], onSelect: () => { }, onAdd: handleAdd }));
